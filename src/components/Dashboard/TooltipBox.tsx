...
export const TooltipBox: React.FC<TooltipBoxProps> = ({
  ...
  <div
    ...
    style={style}
  >
    <div className="text-sfpro font-semibold text-nowrap text-[22.74px] text-black " style={{ letterSpacing: '-0.03em' }}>{city}</div>
    <div className="text-sfpro font-semibold text-nowrap text-[19.89px] text-black" style={{ letterSpacing: '-0.03em' }}>{typeof users === 'number' ? users.toLocaleString() : users}</div>
